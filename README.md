...
7. Set up HTTP nginx. Install the included nginx configuration
   ...
   you have linked to your server via DNS.
...
9. Secure the website with your preferred certificate authority. There are
...
# Troubleshooting
The most common errors I've found are bad gateways and misconfigured WSGI.
